            ...
            <div class="flex items-center space-x-10">
                ...
                <div class="flex items-center space-x-6">
                    <div class="flex items-center space-x-4">
                        <a href="login.php" class="px-6 py-2 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition-all text-sm">Login</a>
                        <a href="register.php" class="px-7 py-3 border-2 border-purple-800/30 text-purple-500 font-bold rounded-lg hover:border-purple-600 hover:bg-purple-600/10 transition-all text-sm">Register</a>
                    </div>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-gray-900/95 backdrop-blur-xl border-t border-white/5 shadow-2xl absolute w-full top-full left-0 z-[100] p-8">
            <div class="flex flex-col items-center space-y-8">
                ...
                <div class="w-full pt-8 border-t border-white/10 flex flex-col space-y-4">
                    <a href="login.php" class="w-full py-4 bg-purple-600 text-white rounded-2xl font-bold shadow-lg text-center">Log In</a>
                    <a href="register.php" class="w-full py-4 border-2 border-purple-800/30 text-purple-600 rounded-2xl font-bold text-center">Create Account</a>
                </div>
            </div>
        </div>
    </nav>
